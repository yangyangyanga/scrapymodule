...
# 2018/3/29
# cmdline.execute("scrapy crawl sheffieldMaster".split())
# cmdline.execute("scrapy crawl newcastleMaster".split())
...
# cmdline.execute("scrapy crawl edinburghMasters".split())
# cmdline.execute("scrapy crawl London_Mary".split())
# cmdline.execute("scrapy crawl queensMasters".split())
